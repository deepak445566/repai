            ...
            >
              ...
              <div className="py-2 px-1 sm:py-2.5 sm:px-2 text-center">
                ...
                <button
                  ...
                  className="w-full  text-white text-xs sm:text-sm font-semibold py-2 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 shadow-md"
                >
                  Book Now →
                </button>
              </div>
