            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-center shadow-md sm:shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <div className={`relative w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 mx-auto mb-3 sm:mb-4 md:mb-5 bg-gradient-to-br ${colorClasses[step.color]} rounded-xl sm:rounded-2xl flex items-center justify-center shadow-md sm:shadow-lg transform rotate-0 group-hover:rotate-12 transition-all duration-300`}>
                    <div className="text-white">
                      {step.icon}
                    </div>
                    {/* Pulse Ring */}
                    <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-500 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  </div>
                  ...
                  <h3 className={`text-sm sm:text-base md:text-lg lg:text-xl font-bold text-gray-900 mb-1 sm:mb-2 md:mb-3 group-hover:text-indigo-600 transition-colors ${
