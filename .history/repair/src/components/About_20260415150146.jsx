...
export default function AboutUs() {
  return (
    <div className="bg-[#FBFCFD] py-12 px-4 lg:px-8 sm:py-16 md:py-20 exo">
      <div className="max-w-7xl mx-auto">
        
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-12 md:gap-16" id='about'>
          
          {/* Left Side - Image */}
          <div className="flex-1 w-full">
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[550px] rounded-2xl overflow-hidden shadow-xl">
              <Image
