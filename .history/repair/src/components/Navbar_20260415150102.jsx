        ...
        <div className="flex justify-between items-center h-18">
          ...
          <div className="hidden md:block">
            <button
              ...
              className="flex items-center gap-2 bg-blue-600 hover:bg-white hover:text-blue-600 transit text-white font-semibold px-6 py-2 rounded-full transition-all text-xl exo"
            >
