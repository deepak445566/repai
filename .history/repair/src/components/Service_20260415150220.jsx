...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 exo">
      <div className="max-w-7xl mx-auto">
        
        <div className="text-center mb-8">
          <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-2" id='services'>
            ...
            <div key={service.id} className="group cursor-pointer">
              ...
              <div className="px-5 pb-2">
                <button
                  ...
                  className="w-full bg-black text-white text-xm font-semibold py-2  rounded-lg "
                >
                  Book Now →
                </button>
              </div>
