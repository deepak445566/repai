    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          {/* Right Section - Image - Fixed for mobile */}
          <div className="flex-1 flex justify-center lg:justify-end w-full">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              ...
              <div className="relative bg-white rounded-2xl overflow-hidden border border-gray-100">
                <div className="relative w-full pt-[100%] sm:pt-[80%] md:pt-[75%]">
                  {/* Fixed aspect ratio container */}
                  <div className="absolute inset-0  w-[350px] h-[450px] md:w-[450px] md:h-[570px]">
                    <Image
