          ...
          {services.map((service) => (
            <div key={service.id} className="group cursor-pointer">
              ...
              <div className="py-2 px-1 text-center">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-800  transition-colors">
                  {service.title}
                </h3>
              </div>
              ...
              <div className="px-3 pb-2">
                <button
                  ...
                  className="w-full bg-black text-white text-xs font-semibold py-2 rounded-lg "
                >
                  Book Now →
                </button>
              </div>
