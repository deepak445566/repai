...
export default function HowItWorks() {
  ...
  const bgColors = {
    blue: "bg-blue-100 group-hover:bg-blue-100",
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-12 sm:py-16 md:py-20 px-4 relative overflow-hidden exo">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-2 sm:mb-4">
            How <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">NAYARA DiAL home service</span> Works
          </h2>
