          ...
          <div className="w-full lg:w-[45%] flex justify-center lg:justify-end">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="relative w-[300px] h-[400px] md:w-[350px] md:h-[400px] lg:w-[450px] lg:h-[500px] lg:w-[450px] lg:h-[500px]  mx-auto ">
                  <Image
                    src="/images/image1.png"
                    alt="Hero Image"
                    fill
                    className="object-contain p-4 mt-8  bg-blue-300 rounded-t-full"
                    priority
                  />
                </div>
              </div>
