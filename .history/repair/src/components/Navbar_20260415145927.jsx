        ...
        <div className="flex justify-between items-center h-18">
          ...
          <div className="flex items-center">
            <a href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-800">
                Nayara <span className="text-indigo-600">Dial</span>
              </span>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8 ">
            {navLinks.map((link) => (
              <a
                ...
                className="text-gray-700 hover:text-indigo-600 font-semibold text-2xl transition-colors"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="hidden md:block">
            <button
              ...
              className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-5 py-2 rounded-full transition-all"
            >
