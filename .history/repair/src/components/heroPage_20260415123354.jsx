...
export default function HeroPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-50 flex items-center justify-center px-4 lg:px-8 py-12">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
         ...
         Expert professionals for AC repair, cleaning, plumbing, appliances & more. Verified, insured, and guaranteed.
          ...
          <div className="w-full lg:w-[45%] flex justify-center lg:justify-end bg-blue-500">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              <div className="absolute inset-0 opacity-60 -z-10"></div>
              <div className="relative overflow-hidden">
                {/* Size control - Apni hisaab se change karo */}
                <div className="relative w-[350px] h-[400px] md:w-[400px] md:h-[400px] lg:w-[400px] lg:h-[550px] mx-auto bg-red-200">
                  <Image
