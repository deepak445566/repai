      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[60%] text-center lg:text-left space-y-6">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 leading-tight uppercase exo">
          ...
          <div className="w-full lg:w-[40%] flex justify-center lg:justify-end">
            <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg">
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="relative w-[300px] h-[300px] md:w-[350px] md:h-[450px] lg:w-[400px] lg:h-[500px] mx-auto">
                  <Image
