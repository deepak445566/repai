...
export default function HeroPage() {
  ...
  return (
    <>
      ...
      {/* Fixed Right Side Buttons - WhatsApp and Phone */}
      <div className="fixed right-6 bottom-6 md:right-8 md:bottom-8 z-50 flex flex-col gap-4">
        {/* WhatsApp Button */}
        <button
          onClick={handleWhatsApp}
          className="group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 hover:shadow-xl"
        ...
        >
          ...
          {/* Tooltip on hover */}
          <span className="absolute right-full mr-3 px-2 py-1 bg-gray-800 text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
            Chat on WhatsApp
          </span>
        </button>
        ...
        <button
          ...
          className="group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-blue-500 rounded-full shadow-lg hover:bg-blue-600 transition-all duration-300 hover:scale-110 hover:shadow-xl"
          aria-label="Call Now"
        >
          <svg
            className="w-7 h-7 md:w-8 md:h-8 text-white"
